...
bool check_out_of_size(const int size_test_tube, const int virus_row, const int virus_column)
{
	if (virus_row < 0 || virus_row >= size_test_tube || virus_column < 0 || virus_column >= size_test_tube) return true;
	return false;
}
